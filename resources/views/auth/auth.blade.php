      ...
      <div class="w-full max-w-md space-y-8">
        ...
        <form id="signin-form" action="/auth/login" method="post" class="space-y-6">
          ...
          <div>
            ...
            <div class="relative">
              <input type="password" id="signin-password" name="password" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600" placeholder="••••••••" required>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input type="checkbox" id="remember-me" name="remember-me" class="h-4 w-4 text-indigo-600 border-gray-300 rounded">
              <label for="remember-me" class="ml-2 text-sm text-gray-600">Remember me</label>
            </div>
            <a href="/auth/forgot-password" class="text-sm text-indigo-600 hover:text-indigo-500 transition-colors duration-200">Forgot password?</a>
          </div>
          <button type="submit" class="w-full bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-200 transition-colors duration-200">
            Sign in
          </button>
          <div class="relative">
          ...
          <div class="text-center text-sm text-gray-600">
            ...
            <span class="text-indigo-600 hover:text-indigo-500 cursor-pointer transition-colors duration-200">Sign up</span>
          </div>
        </form>
        ...
        <form id="signup-form" action="/auth/register" method="post" class="hidden space-y-6">
          ...
          <div>
            ...
            <div class="relative">
              <input type="password" id="signup-password" name="password" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600" placeholder="••••••••" required>
              <button type="button" class="absolute right-3 top-2 text-gray-500">
          ...
          <div>
            ...
            <div class="relative">
              <input type="password" id="signup-confirm-password" name="confirm_password" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600" placeholder="••••••••" required>
              <button type="button" class="absolute right-3 top-2 text-gray-500" >
      ...
      <option value="#">Select your preffered Currency</option>
        ...
        @endforeach
          ...
          <div class="text-center text-sm text-gray-600">
            ...
            <span class="text-indigo-600 hover:text-indigo-500 cursor-pointer transition-colors duration-200">Sign in</span>
          </div>
        </form>
      </div>
    </div>
